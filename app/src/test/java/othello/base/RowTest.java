...
public class RowTest {
  ...
  void down() {
    ...
    assertEquals(Row.ROW_5, Row.ROW_4.down().orElse(null));
    assertEquals(Row.ROW_6, Row.ROW_5.down().orElse(null));
    assertEquals(Row.ROW_7, Row.ROW_6.down().orElse(null));
    assertEquals(Row.ROW_8, Row.ROW_7.down().orElse(null));
    assertNull(Row.ROW_8.down().orElse(null));
  }
  ...
  void up() {
    ...
    assertEquals(Row.ROW_3, Row.ROW_4.up().orElse(null));
    assertEquals(Row.ROW_4, Row.ROW_5.up().orElse(null));
    assertEquals(Row.ROW_5, Row.ROW_6.up().orElse(null));
    assertEquals(Row.ROW_6, Row.ROW_7.up().orElse(null));
    assertEquals(Row.ROW_7, Row.ROW_8.up().orElse(null));
  }
